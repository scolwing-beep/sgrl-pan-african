...
const BREVO_ACTION = 'https://213276e6.sibforms.com/serve/MUIFAILVXUVqAnsmytN-8nehoL5wOTa6Y7XILiIlrpxWg1EMUFTHChQtnX857mL3p8OQB3kpRc8g1OnopnB2NV9giwmWv6-UiQSxhQ97Ed47Geds00_6vOp-zrcBStRHoJ7vwN4CLNjEwlSWq3Cko2-mavtjZCSyKfPzSJ8LHs7Nb3mormJ-ck6EW72PiWRnzm92vmiE4ds9lWHyqQ=='
  ...
  return (
    <section className="newsletter" id="newsletter">
      ...
      <div className="newsletter-content" ref={ref}>
        ...
        <div className={`sib-form anim-slide-right${isInView ? ' in-view' : ''} delay-2`}>
          <div id="sib-form-container" className="sib-form-container">
            <div id="error-message" className="sib-form-message-panel" style={{ fontSize: '16px', textAlign: 'left', fontFamily: 'Helvetica, sans-serif', color: '#661d1d', backgroundColor: '#ffeded', borderRadius: '3px', borderColor: '#ff4949', maxWidth: '540px', margin: '0 auto' }}>
            ...
            <div></div>
            <div id="success-message" className="sib-form-message-panel" style={{ fontSize: '16px', textAlign: 'left', fontFamily: 'Helvetica, sans-serif', color: '#085229', backgroundColor: '#e7faf0', borderRadius: '3px', borderColor: '#13ce66', maxWidth: '540px', margin: '0 auto' }}>
              <div className="sib-form-message-panel__text sib-form-message-panel__text--center">
                <svg viewBox="0 0 512 512" className="sib-icon sib-notification__icon">
              ...
              <form id="sib-form" method="POST" action={BREVO_ACTION} data-type="subscription">
                <div className="newsletter-fields">
                  ...
                  <div className="sib-form-block">
                    <button
                      className="sib-form-block__button sib-form-block__button-with-loader newsletter-btn"
                      form="sib-form"
                      type="submit"
                    >
