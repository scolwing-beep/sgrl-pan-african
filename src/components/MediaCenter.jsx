...
const galleryImages = [
  ...
  { src: 'https://images.unsplash.com/photo-1595508064774-5ff825a66588?w=400&q=80', alt: 'Commodity trade' },
  { src: 'https://images.unsplash.com/photo-1591882897919-61ebba80dc62?w=400&q=80', alt: 'Cassava roots' },
...
function MediaCenter() {
  ...
  const [galleryGridRef, galleryGridInView] = useInView()
        ...
        <div className="media-container">
          ...
          <div className="gallery-grid" ref={galleryGridRef}>
            {galleryImages.map((image, index) => (
              <div key={index} className={`gallery-item anim-zoom${galleryGridInView ? ' in-view' : ''} delay-${index + 1}`}>
